        ...
        <div class="container">
            <div class="signin-content">
                <!-- <div class="signin-image">
                    ...
                    <!-- <input type="submit" class="form-submit" value="Create an account"/> -->
                    ...
                    <form method="POST" action="{{route('dashboard')}}">
                        ...
                        <div class="mb-3">
                            <div class="w-75">
                                ...
                                style="height: 30px; font-size:13px; color:red; padding:10px; width:100%; background: black; border-radius: 10px">
